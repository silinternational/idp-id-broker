...
func verifyU2FFormat(att AttestationObject, clientDataHash []byte) (string, []interface{}, error) {
	...
	log.Printf("Post equal AAGUID 0's")
	...
	log.Printf("Post AttStatement signature")
	...
	log.Printf("Post ParseCertificate")
	...
	if sigErr != nil {
	    log.Printf("Step 6 error: %v", sigErr)
	    log.Printf("Step 6 signature: %s", signature)
