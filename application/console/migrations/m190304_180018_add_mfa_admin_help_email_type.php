 ...
 */
class m190304_180018_add_mfa_admin_help_email_type extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $this->alterColumn(
            ...
            "'mfa-enabled','mfa-disabled','method-verify','mfa-manager','mfa-manager-help', 'mfa-admin', 'mfa-admin-help') NULL"
        );
    }
