...
{
    const EMAIL = '/email';
    const HTML_BODY_TEXT = 'html body';
    const TEST_EXAMPLE_ORG = 'test@example.org';
    const TESTBCC_EXAMPLE_ORG = 'testbcc@example.org';
    const TESTCC_EXAMPLE_ORG = 'testcc@example.org';
    const TEXT_BODY_TEXT = 'text body';
    const SUBJECT_TEXT = 'subject text';
    ...
    const ATTEMPTS_COUNT = 'attempts_count';
