...
We noticed you have a Security Key configured for 2-Step Verification on your
<?= $idpDisplayName ?> Identity account but have not used it recently and
...
If you need to remove the Security Key from your Identity account:
   ...
   2. Log in if needed
   3. Under the 2-Step Verification section, click "I LOST MY KEY" next to
